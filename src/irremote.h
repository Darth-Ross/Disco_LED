...
CH_MINUS, CH_PLUS, STOP_MODE, SETUP, ENTER_SAVE, ZERO_TEN, ONE, TWO, THREE, FOUR, FIVE, SIX, SEVEN, EIGHT, NINE, REPEAT, BPLUS,
BMIN, OFF, ON, R, G ,B , W, B1, B2, B3, FLASH, B4, B5, B6, STROBE, B7, B8, B9, FADE, B10, B11, B12, SMOOTH} commandAction;
